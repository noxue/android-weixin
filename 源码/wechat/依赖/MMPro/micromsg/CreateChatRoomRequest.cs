namespace micromsg
{
    ...
    [Serializable, ProtoContract(Name="CreateChatRoomRequest")]
    public class CreateChatRoomRequest : IExtensible
    {
        ...
        [ProtoMember(6, IsRequired=false, Name="ExtBuffer", DataFormat=DataFormat.Default), DefaultValue((string) null)]
