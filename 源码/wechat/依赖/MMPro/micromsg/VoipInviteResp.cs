namespace micromsg
{
    ...
    [Serializable, ProtoContract(Name="VoipInviteResp")]
    public class VoipInviteResp : IExtensible
    {
        ...
        [ProtoMember(0x10, IsRequired=false, Name="AudioDTX", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]
        public int AudioDTX
        {
            get
            {
        ...
        [ProtoMember(0x15, IsRequired=false, Name="AudioEnableSpkec", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]
        ...
        [ProtoMember(0x13, IsRequired=false, Name="Hw264SvrCfg", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]
        ...
        [ProtoMember(7, IsRequired=false, Name="RelayData", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        ...
        [ProtoMember(0x12, IsRequired=false, Name="SwitchInterval", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x11, IsRequired=false, Name="TcpCnt", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        public uint TcpCnt
        {
            get
            {
