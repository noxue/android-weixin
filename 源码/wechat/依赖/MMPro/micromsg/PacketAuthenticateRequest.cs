namespace micromsg
{
    ...
    [Serializable, ProtoContract(Name="PacketAuthenticateRequest")]
    public class PacketAuthenticateRequest : IExtensible
    {
        ...
        [ProtoMember(3, IsRequired=false, Name="Data", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        public byte[] Data
        {
            get
            {
