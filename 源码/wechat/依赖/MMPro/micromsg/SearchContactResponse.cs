namespace micromsg
{
    ...
    [Serializable, ProtoContract(Name="SearchContactResponse")]
    public class SearchContactResponse : IExtensible
    {
        ...
        private uint _ContactCount = 0;
        private readonly List<SearchContactItem> _ContactList = new List<SearchContactItem>();
        private string _Country = "";
        private micromsg.CustomizedInfo _CustomizedInfo = null;
        private SKBuiltinBuffer_t _ImgBuf;
        private string _KFWorkerID = "";
        ...
        private SKBuiltinBuffer_t _ResBuf = null;
        private int _Sex;
        ...
        [ProtoMember(20, IsRequired=false, Name="AlbumBGImgID", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x13, IsRequired=false, Name="AlbumFlag", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]
        ...
        [ProtoMember(0x12, IsRequired=false, Name="AlbumStyle", DataFormat=DataFormat.TwosComplement), DefaultValue(0)]
        ...
        [ProtoMember(15, IsRequired=false, Name="Alias", DataFormat=DataFormat.Default), DefaultValue("")]
        public string Alias
        {
            get
            {
        ...
        [ProtoMember(30, IsRequired=false, Name="AntispamTicket", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x1b, IsRequired=false, Name="BigHeadImgUrl", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x19, IsRequired=false, Name="ContactCount", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x1a, Name="ContactList", DataFormat=DataFormat.Default)]
        public List<SearchContactItem> ContactList
        {
            get
            {
        ...
        [ProtoMember(0x16, IsRequired=false, Name="Country", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x18, IsRequired=false, Name="CustomizedInfo", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        ...
        [ProtoMember(7, IsRequired=true, Name="ImgBuf", DataFormat=DataFormat.Default)]
        ...
        [ProtoMember(0x1f, IsRequired=false, Name="KFWorkerID", DataFormat=DataFormat.Default), DefaultValue("")]
        public string KFWorkerID
        {
            get
            {
                return this._KFWorkerID;
            }
            set
            {
                this._KFWorkerID = value;
            }
        }

        [ProtoMember(0x20, IsRequired=false, Name="MatchType", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x17, IsRequired=false, Name="MyBrandList", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x1d, IsRequired=false, Name="ResBuf", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        ...
        [ProtoMember(0x1c, IsRequired=false, Name="SmallHeadImgUrl", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x15, IsRequired=false, Name="SnsUserInfo", DataFormat=DataFormat.Default), DefaultValue((string) null)]
        ...
        [ProtoMember(12, IsRequired=false, Name="VerifyFlag", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(13, IsRequired=false, Name="VerifyInfo", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(14, IsRequired=false, Name="Weibo", DataFormat=DataFormat.Default), DefaultValue("")]
        public string Weibo
        {
            get
            {
        ...
        [ProtoMember(0x11, IsRequired=false, Name="WeiboFlag", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x10, IsRequired=false, Name="WeiboNickname", DataFormat=DataFormat.Default), DefaultValue("")]
