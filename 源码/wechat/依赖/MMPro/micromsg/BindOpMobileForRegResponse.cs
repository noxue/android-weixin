namespace micromsg
{
    ...
    [Serializable, ProtoContract(Name="BindOpMobileForRegResponse")]
    public class BindOpMobileForRegResponse : IExtensible
    {
        ...
        private uint _MmtlsControlBitFlag = 0;
        private uint _MobileCheckType = 0;
        ...
        [ProtoMember(0x12, IsRequired=false, Name="MmtlsControlBitFlag", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x15, IsRequired=false, Name="MobileCheckType", DataFormat=DataFormat.TwosComplement), DefaultValue((long) 0L)]
        ...
        [ProtoMember(0x16, IsRequired=false, Name="regSessionId", DataFormat=DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(0x13, IsRequired=false, Name="SmsUpCode", DataFormat=DataFormat.Default), DefaultValue("")]
