...
# 获取群列表
def get_group_list(contact_type=Util.CONTACT_TYPE_CHATROOM):
    return Util.get_contact(contact_type)

# 获取公众号列表
def get_gzh_list(contact_type=Util.CONTACT_TYPE_OFFICAL):
    return Util.get_contact(contact_type)

# 获取黑名单列表
def get_hmd_list(contact_type=Util.CONTACT_TYPE_BLACKLIST):
    return Util.get_contact(contact_type)

# 获取删除好友列表
def get_delcontact_list(contact_type=Util.CONTACT_TYPE_DELETED):
    return Util.get_contact(contact_type)
